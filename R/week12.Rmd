...
# Extract the beta matrix (term-topic matrix)
...
#Interpretation: The wordcloud shows that the most frequent words in the io_corpus are related to the topics of "research" , "career", "master", and "job", suggests that these topics are important and frequently discussed in the io_psychology subreddit.
```
...
upvote_tbl <- tibble(upvote_count = upvotes)
